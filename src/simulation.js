...
export class Simulation {
  ...
  // Chase pack: Myvi, Wira, Tesla, Myvi Yellow and Satria start behind the
  // player and hunt it with direct pursuit. They have no route (route-bound
  // helpers must skip them); perception and collision-proximity helpers are
  // position-based and handle them. Tesla is the fastest, Wira the slowest.
  static CHASE_PACK = [
